...
assert.equal(getEducatorDrawModeLimit(EDUCATOR_TIER_TARGET - 1), BASIC_EDUCATOR_MAX_DRAW_MODE);
assert.equal(getEducatorDrawModeLimit(EDUCATOR_TIER_TARGET), ADVANCED_EDUCATOR_MAX_DRAW_MODE);
